...
function SignupConfirmation() {
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$authReducers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyOTP"].rejected.match(resultAction)) {
...
_s(SignupConfirmation, "7meha+vwkeS8naIOUJO0DSFxCKM=", false, function() {
    return [
